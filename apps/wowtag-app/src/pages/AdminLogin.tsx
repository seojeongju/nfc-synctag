    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] p-4 font-sans leading-relaxed text-slate-900 animate-in fade-in duration-300">
      <div className="bg-white p-8 lg:p-12 rounded-[2.5rem] shadow-xl border border-slate-100/80 w-full max-w-md flex flex-col relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h2 className="text-3xl font-black tracking-tight bg-clip-text text-transparent bg-purple-gradient">Gold SyncTag</h2>
          <p className="text-slate-400 text-xs font-bold mt-1 tracking-wider uppercase">관리자 로그인</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          {error && (
            <p className="text-xs font-bold text-rose-500 text-center bg-rose-50/60 p-3 rounded-xl border border-rose-100 animate-in fade-in duration-200">
              {error}
            </p>
          )}
